...
export default function NewsArticle() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <section
        className="relative min-h-[52vh] flex items-end pt-28 pb-14 px-6 lg:px-8"
        style={{
      ...
      >
        <div className="max-w-7xl mx-auto w-full">
          ...
          <h1 className="text-3xl lg:text-4xl font-black text-white leading-tight mt-3 max-w-3xl">
            {post.title}
          </h1>
        </div>
      </section>
